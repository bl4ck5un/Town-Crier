...
\usepackage{titlesec}
\titlespacing*{\section}{0pt}{1.0\baselineskip}{.9\baselineskip}
\titlespacing*{\subsection}{0pt}{0.8\baselineskip}{.8\baselineskip}
...
\newcommand{\constgasmin}{\sblue{\$G_\text{min}}}
\newcommand{\constgasmax}{\sblue{\$G_\text{max}}}
\newcommand{\constgascancel}{\sblue{\$G_\emptyset}}
...
\newcommand{\constgasinvokecancel}{\sblue{\$G_\text{cncl}}}
\newcommand{\constgasrequest}{\sblue{\$G_\text{req}}}
\newcommand{\consthonestfee}{\sblue{\$F}}
