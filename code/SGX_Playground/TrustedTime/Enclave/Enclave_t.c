...
static sgx_status_t SGX_CDECL sgx_showtime(void* pms)
{
...
static sgx_status_t SGX_CDECL sgx_create_session(void* pms)
{
	sgx_status_t status = SGX_SUCCESS;
	if (pms != NULL) return SGX_ERROR_INVALID_PARAMETER;
	create_session();
...
SGX_EXTERNC const struct {
	...
	2,
	{
		{(void*)(uintptr_t)sgx_showtime, 0},
		{(void*)(uintptr_t)sgx_create_session, 0},
	}
};
