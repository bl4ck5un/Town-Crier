...
static const struct {
	...
	9,
	{
		(void*)(uintptr_t)Enclave3_session_request_ocall,
		(void*)(uintptr_t)Enclave3_exchange_report_ocall,
		(void*)(uintptr_t)Enclave3_send_request_ocall,
		(void*)(uintptr_t)Enclave3_end_session_ocall,
