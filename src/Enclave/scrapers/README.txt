The Scraper interface has one function called handle_event that is responsibble for handling any requested event.  To add a Scraper class, simply make it a subclass of the Scraper interface and provide an implementation of for handle_request.  
