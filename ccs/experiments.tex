...
%The callback-independent cost of calling \tc (i.e., the cost of the datagram, not the application) for our example applications ranges from 12 to 16 cents.
%The variation results from different parameter lengths and whether {\bf Cancel} is called.
