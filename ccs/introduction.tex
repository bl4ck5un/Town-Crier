...
\vspace{1ex}
\noindent {\em Definition of gas sustainability.}
...
\vspace{1ex}
\noindent {\em Minimized Trusted Computing Base (TCB) across multiple components.}
...
\vspace{1ex}
\noindent{\em Private and custom datagrams.}
