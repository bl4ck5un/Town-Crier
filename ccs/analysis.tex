...
\begin{theorem}[\tcs is Gas Sustainable]
\label{thm:tc-gas-sustainable}
\tc is gas sustainable when the initial value of \tcadd is at least \constgasmax.
\end{theorem}

The proof of Theorem~\ref{thm:tc-gas-sustainable} follows from examining when and how money can flow in Fig~\ref{tbl:gas-tc-contract}.
We perform this analysis carefully in Appendix~\ref{sec:analysis-proofs}.
