...
\begin{theorem}[Gas Sustainability]
...
Another security concern we took into consideration 
is \skTC's resilience to power outage. This is 
addressed using the sealing functionality~\cite{sgxmanual, anati2013innovative}
provided by SGX. Also, ``sealing to the sealing identity'' can be used to 
upgrade the enclave code after deployment. Due to space constraints, we refer reads
to~\cite{anati2013innovative, sgxmanual} for details regarding sealing policies in SGX.
