...
The proof of Theorem~\ref{thm:tc-gas-sustainable} follows from noting that an honest \tc will only call {\bf Deliver}
and examining when and how money can flow in Fig~\ref{fig:tc-contract}.
