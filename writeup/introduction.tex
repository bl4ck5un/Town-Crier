...
To meet smart contracts' need for data, the architects of Ethereum proposed the deployment of \emph{data feeds}, contracts on the blockchain that serve data requests by other contracts. Their origianl 
