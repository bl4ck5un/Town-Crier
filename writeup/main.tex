...
\usepackage{tikz}
\usetikzlibrary{arrows,calc,fit,positioning,shapes.misc,shapes}
...
\tikzset{%
  ...
  bg-box/.style={rectangle,rounded corners,draw=black,dashed,inner sep=0},
  blockchain-color/.style={fill=blue!12},
...
\newcommand {\tcadd} {\ensuremath{{\cal W}_{TC}}\xspace}
\newcommand {\pTC} {\ensuremath{{\cal W}_{TC}}\xspace}
\newcommand {\cont} {\ensuremath{{\cal C}}\xspace}
\newcommand {\sgxadd} {\ensuremath{{\cal W}_{SGX}}\xspace}
=======
\newcommand {\cont} {\ensuremath{{\cal C}}\xspace}
\newcommand {\wallet} {\ensuremath{{\cal P}}\xspace}
...
{\footnotesize
  ...
  \bibliography{ethereum,sgx,elaine}
}
