...
The $\gascallback$ is thin because that value is limited by {\bf Deliver}.
}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item {\it Town Crier blockchain contract.}
    ...
    Since $\tcadd$ must invoke {\bf Deliver}, \tc will pays the gast cost.
    It sets the {\tt GASLIMIT} $\gasdeliver := \constgasmax$.
    We prove in Section \ethan{ref gas-neutrality} that this is always enough gas and it will not spend more than is refunded.
