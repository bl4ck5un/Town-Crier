...
\begin{tikzpicture}
  ...
  \path[-stealth,color=maroon,ultra thick] (cu.south) edge [left,transform canvas={xshift=3.25em}] node [blocked-out-label,xshift=1em,yshift=1.4em] {\small \smash{$\gasrequest + \fee$}} ([yshift=-1.25em]ctc.north);
  ...
  \draw[color=gold,opacity=0.35,line width=0.5ex] ([yshift=1em]tc-wallet.east) -| ([xshift=-3em]ctc.north);
