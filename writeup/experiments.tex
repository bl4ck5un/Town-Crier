...
83.4 ms (18.5 ms for report generation, 
and 64.9 ms for quote generation).
...
19.0 ms, consumed mostly by digital signing using $\pkTC$ (18.5 ms). To this must be added the wide-area network roundtrip latency, at most typically a few hundred milliseconds. %Note too that the user can measure the the latency of its timestamp verification, and therefore determine the accuracy of its measurement.
