...
During the creation and fulfillment of any request, there are two untrusted parties: The requester constract / user $\reqcont$ and the \tc~\medname. In the \tc implementation, we thus consider three cases, here giving the desired properties of each:
