...
We also refer the reader to Appendix~\ref{sec:applicationsfull}
for more implementation details of these applicatins,
...
To avoid leaking information through timing (e.g.,
when the flight 
