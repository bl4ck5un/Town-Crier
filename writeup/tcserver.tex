...
\begin{tikzpicture}
  ...
  \path[->,color=red,above] (ocall-leg.west) edge node {ocall} (ocall-leg.east);
  \path[<-,color=red,dashed,transform canvas={yshift=-0.3em}] (ocall-leg.west) edge (ocall-leg.east);

  \path[->,color=blue,above] (ecall-leg.west) edge node {ecall} (ecall-leg.east);
  \path[<-,color=blue,dashed,transform canvas={yshift=-0.3em}] (ecall-leg.west) edge (ecall-leg.east);
\end{tikzpicture}
