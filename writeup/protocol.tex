...
Here, $\dgid$ denotes a unique request identifier; it is assigned to $m_1$ by \tcont and communicated to \reqcont. 
For simplicity, we depict $\dgid$ as part of the communicated message, and give details on its assignment below.
