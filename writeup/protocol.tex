...
%                 & \hspace*{1em} Return $\smaroon{\$fee}$ to $\pkU$ \\
		& Assert ${\color{blue} \Time_{\text{timeout}}} > {\sf cur\_time}$\\
                 & Record $({\sf id}, {\sf callback}, {\sf params}, \smaroon{\$ F_{\text{deliver}}}, {\color{blue} \Time_{\text{timeout}}}, \pkU)$
%   & Send $(\dgid, \dgform, \smaroon{\$ F_{\text{deliver}}})$ to \relay 
