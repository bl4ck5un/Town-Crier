...
\caption{Formal abstraction for SGX execution capturing a subset of SGX features
  sufficient for implementation of \tc.\fan{A minor issue: \sigatt should include Hash(\enclaveprog), not \enclaveprog}
}
