...
\begin{tikzpicture}
  [contract/.style={entity,minimum height=3.5em,text width=7.5em},
   ...
   type-box/.style={type-box-color,draw=black,dashed},
...
%  \node[anchor=north,xshift=1em,yshift=-0.5em] () at (cu.south) {\small \bf \underline{\smash{Request}}};
  ...
  \path[->,color=maroon,line width=0.4ex] (ctc.west) edge [transform canvas={yshift=-1.25em}] node [blockchain-color,xshift=0.4em] {\small $\fee$} ([xshift=-0.8em]tc-wallet.east);
