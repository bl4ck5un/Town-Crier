...
Several technical challenges arise: Checking EPID sigs, Relay corruption of messages, authenticating messages on blockchain when they come from an off-chain entity, etc.
