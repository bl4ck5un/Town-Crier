...
\begin{tikzpicture}
  ...
  \node[rectangle,draw=black,trusted,right=2.75em of tc,anchor=north,rotate=90,text width=9em,minimum height=5em,align=center,label=right:{\bf Data Source}] (data) {\tt lots-o-data.com};
  ...
  \draw[stealth-stealth,communication] ([xshift=0.75em,yshift=-0.75em]enc.north) |- ([xshift=0.75em,yshift=1.75em]data.north);
\end{tikzpicture}
