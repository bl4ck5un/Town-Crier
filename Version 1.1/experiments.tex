...
\subsection{TCB Size}
We first profile the trusted computing based (TCB) size of Town Crier, which
includes \tc~\encname and \tcontract. \tc~\encname consits of approximately 46.4k
lines of C/C++ code, most (42.7k lines) of which is the modified mbedTLS~\cite{mbedtls}
library. The source code of mbedTLS has been widely deployed and tested while the
remainder of \tc~\encname codebase is small enough to admit formal verification.
\tcontract has approximately 120 lines of Solidity code.
